            ...
            <div>
                ...
                <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                    ...
                    >
                        ...
                        >
                            {loading
                                ? "Analyzing content and finding perfect matches..."
                                : "Personalized video recommendations based on your content"}
                        </motion.p>
                    </motion.div>
